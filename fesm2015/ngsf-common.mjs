...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(JsonPointer, [{
            type: Injectable
        }], null, null);
})();
...
Framework.ɵfac = function Framework_Factory(t) { return new (t || Framework)(); };
Framework.ɵprov = i0.ɵɵdefineInjectable({ token: Framework, factory: Framework.ɵfac });
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(Framework, [{
            type: Injectable
        }], null, null);
})();
...
//# sourceMappingURL=ngsf-common.mjs.map
//# sourceMappingURL=ngsf-common.mjs.map
