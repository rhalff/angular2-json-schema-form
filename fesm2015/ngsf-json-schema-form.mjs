...
function JsonSchemaFormComponent_div_0_Template(rf, ctx) {
    if (rf & 1) {
...
function JsonSchemaFormComponent_div_4_Template(rf, ctx) {
    if (rf & 1) {
        i0.ɵɵelementStart(0, "div");
...
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(JsonSchemaFormModule, { declarations: [JsonSchemaFormComponent], imports: [CommonModule,
            FormsModule,
            ReactiveFormsModule,
