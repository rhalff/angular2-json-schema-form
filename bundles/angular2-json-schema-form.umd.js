(function (global, factory) {
    ...
    (factory((global['angular2-json-schema-form'] = {}),global.tslib,global.rxjs.Observable,global.rxjs.observable.fromPromise,global.rxjs.operator.toPromise,global.ng.core,global.rxjs.observable.forkJoin,global.rxjs.operator.map,global._,global.ng.forms,global.rxjs.Subject,global.Ajv,global.ng.platformBrowser,global.ng.common,global.ng['flex-layout'],global.ng.material));
    ...
    */
    ...
    var MaterialDesignFrameworkComponent = (function () {
        ...
        MaterialDesignFrameworkComponent.prototype.initializeFramework = function () {
            if (this.layoutNode) {
                ...
                this.widgetLayoutNode = Object.assign({}, this.layoutNode, { options: lodash.cloneDeep(this.layoutNode.options || {}) });
    ...
    var MaterialDesignFramework = (function (_super) {
        tslib.__extends(MaterialDesignFramework, _super);
    ...
    MaterialDesignFrameworkModule.decorators = [
        { type: core.NgModule, args: [{
                    ...
                    entryComponents: tslib.__spread(MATERIAL_FRAMEWORK_COMPONENTS)
                },] },
    ];
    /**
    ...
    var Bootstrap3Framework = (function (_super) {
        tslib.__extends(Bootstrap3Framework, _super);
    ...
    var Bootstrap4Framework = (function (_super) {
        tslib.__extends(Bootstrap4Framework, _super);
