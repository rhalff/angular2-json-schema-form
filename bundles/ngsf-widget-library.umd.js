(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs-compat/Subject'), require('ajv/lib/refs/json-schema-draft-06.json'), require('ajv'), require('lodash'), require('@ngsf/common'), require('@angular/common'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('@ngsf/widget-library', ['exports', '@angular/core', 'rxjs-compat/Subject', 'ajv/lib/refs/json-schema-draft-06.json', 'ajv', 'lodash', '@ngsf/common', '@angular/common', '@angular/forms'], factory) :
    (global = global || self, factory((global.ngsf = global.ngsf || {}, global.ngsf['widget-library'] = {}), global.ng.core, global.Subject, global.draft6, global.Ajv, global.lodash, global.common, global.ng.common, global.ng.forms));
}(this, (function (exports, core, Subject, draft6, Ajv, lodash, common, common$1, forms) { 'use strict';
    ...
    var JsonSchemaFormService = (function () {
        ...
        JsonSchemaFormService.prototype.setLanguage = function (language) {
            ...
            var validationMessages = language.slice(0, 2) === 'fr' ?
                common.frValidationMessages : common.enValidationMessages;
        ...
        JsonSchemaFormService.prototype.buildRemoteError = function (errors) {
            var _this = this;
            common.forEach(errors, (function (value, key) {
                var e_1, _a;
        ...
        JsonSchemaFormService.prototype.validateData = function (newValue, updateSubscriptions) {
            ...
            this.data = common.formatFormData(newValue, this.dataMap, this.dataRecursiveRefMap, this.arrayMap, this.formOptions.returnEmptyFields);
        ...
        JsonSchemaFormService.prototype.buildFormGroupTemplate = function (formValues, setValues) {
            ...
            this.formGroupTemplate = common.buildFormGroupTemplate(this, formValues, setValues);
        };
        JsonSchemaFormService.prototype.buildFormGroup = function () {
            var _this = this;
            this.formGroup = ((common.buildFormGroup(this.formGroupTemplate)));
            if (this.formGroup) {
        ...
        JsonSchemaFormService.prototype.buildLayout = function (widgetLibrary) {
            this.layout = common.buildLayout(this, widgetLibrary);
        };
        JsonSchemaFormService.prototype.setOptions = function (newOptions) {
            if (common.isObject(newOptions)) {
                var addOptions = lodash.cloneDeep(newOptions);
                if (common.isObject(addOptions.defaultOptions)) {
                    Object.assign(this.formOptions.defautWidgetOptions, addOptions.defaultOptions);
                    delete addOptions.defaultOptions;
                }
                if (common.isObject(addOptions.defautWidgetOptions)) {
                ...
                ['ErrorState', 'SuccessState']
                    .filter((function (suffix) { return common.hasOwn(globalDefaults_1, 'disable' + suffix); }))
        ...
        JsonSchemaFormService.prototype.buildSchemaFromData = function (data, requireAllFields) {
            ...
            if (data) {
                return common.buildSchemaFromData(data, requireAllFields);
            }
            this.schema = common.buildSchemaFromData(this.formValues, requireAllFields);
        };
        JsonSchemaFormService.prototype.buildSchemaFromLayout = function (layout) {
            if (layout) {
                return common.buildSchemaFromLayout(layout);
            }
            this.schema = common.buildSchemaFromLayout(this.layout);
        };
        ...
        JsonSchemaFormService.prototype.parseExpression = function (expression, value, values, key, tpldata) {
            ...
            if (expression === 'value' && !common.hasOwn(values, 'value')) {
                return value;
            }
            if (['"', '\'', ' ', '||', '&&', '+'].every((function (delimiter) { return expression.indexOf(delimiter) === -1; }))) {
                var pointer = common.JsonPointer.parseObjectPath(expression);
                return pointer[0] === 'value' && common.JsonPointer.has(value, pointer.slice(1)) ?
                    common.JsonPointer.get(value, pointer.slice(1)) :
                    pointer[0] === 'values' && common.JsonPointer.has(values, pointer.slice(1)) ?
                        common.JsonPointer.get(values, pointer.slice(1)) :
                        pointer[0] === 'tpldata' && common.JsonPointer.has(tpldata, pointer.slice(1)) ?
                            common.JsonPointer.get(tpldata, pointer.slice(1)) :
                            common.JsonPointer.has(values, pointer) ? common.JsonPointer.get(values, pointer) : '';
            }
        ...
        JsonSchemaFormService.prototype.setArrayItemTitle = function (parentCtx, childNode, index) {
            ...
            var isArrayItem = (parentNode.type || '').slice(-5) === 'array' && common.isArray(parentValues);
            var text = common.JsonPointer.getFirst(isArrayItem && childNode.type !== '$ref' ? [
            ...
            var childValue = common.isArray(parentValues) && index < parentValues.length ?
        ...
        JsonSchemaFormService.prototype.setItemTitle = function (ctx) {
            return !ctx.options.title && /^(\d+|-)$/.test(ctx.layoutNode.name) ?
                null :
                this.parseText(ctx.options.title || common.toTitleCase(ctx.layoutNode.name), this.getFormControlValue(this), (this.getFormControlGroup(this) || (({}))).value, ctx.dataIndex[ctx.dataIndex.length - 1]);
        };
        JsonSchemaFormService.prototype.evaluateCondition = function (layoutNode, dataIndex) {
            ...
            var result = true;
            if (common.hasValue((layoutNode.options || {}).condition)) {
                if (typeof layoutNode.options.condition === 'string') {
                    var pointer = layoutNode.options.condition;
                    if (common.hasValue(arrayIndex)) {
                        pointer = pointer.replace('[arrayIndex]', "[" + arrayIndex + "]");
                    }
                    pointer = common.JsonPointer.parseObjectPath(pointer);
                    result = !!common.JsonPointer.get(this.data, pointer);
                    if (!result && pointer[0] === 'model') {
                        result = !!common.JsonPointer.get({ model: this.data }, pointer);
                    }
                }
        ...
        JsonSchemaFormService.prototype.initializeControl = function (ctx, bind) {
            ...
            if (!common.isObject(ctx)) {
                return false;
            }
            if (common.isEmpty(ctx.options)) {
                ctx.options = !common.isEmpty((ctx.layoutNode || {}).options) ?
            ...
            if (ctx.formControl) {
                ...
                ctx.options.showErrors = this.formOptions.validateOnRender === true ||
                    (this.formOptions.validateOnRender === 'auto' && common.hasValue(ctx.controlValue));
        ...
        JsonSchemaFormService.prototype.formatErrors = function (errors, validationMessages) {
            ...
            if (common.isEmpty(errors)) {
                return null;
            }
            if (!common.isObject(validationMessages)) {
                validationMessages = {};
            }
        ...
        JsonSchemaFormService.prototype.updateValue = function (ctx, value) {
            ...
            if (common.isArray(ctx.options.copyValueTo)) {
                try {
                    for (var _b = __values(ctx.options.copyValueTo), _c = _b.next(); !_c.done; _c = _b.next()) {
                        var item = _c.value;
                        var targetControl = common.getControl(this.formGroup, item);
                        if (common.isObject(targetControl) && typeof targetControl.setValue === 'function') {
        ...
        JsonSchemaFormService.prototype.updateArrayCheckboxList = function (ctx, checkboxList) {
            ...
            var refPointer = common.removeRecursiveReferences(ctx.layoutNode.dataPointer + '/-', this.dataRecursiveRefMap, this.arrayMap);
            try {
                for (var checkboxList_1 = __values(checkboxList), checkboxList_1_1 = checkboxList_1.next(); !checkboxList_1_1.done; checkboxList_1_1 = checkboxList_1.next()) {
                    ...
                    if (checkboxItem.checked) {
                        var newFormControl = common.buildFormGroup(this.templateRefLibrary[refPointer]);
        ...
        JsonSchemaFormService.prototype.getFormControl = function (ctx) {
            if (!ctx.layoutNode || !common.isDefined(ctx.layoutNode.dataPointer) ||
                ctx.layoutNode.type === '$ref') {
                return null;
            }
            return common.getControl(this.formGroup, this.getDataPointer(ctx));
        };
        JsonSchemaFormService.prototype.getFormControlValue = function (ctx) {
            ...
            var control = common.getControl(this.formGroup, this.getDataPointer(ctx));
        ...
        JsonSchemaFormService.prototype.getFormControlGroup = function (ctx) {
            ...
            return common.getControl(this.formGroup, this.getDataPointer(ctx), true);
        };
        JsonSchemaFormService.prototype.getFormControlName = function (ctx) {
            if (!ctx.layoutNode || !common.isDefined(ctx.layoutNode.dataPointer) || !common.hasValue(ctx.dataIndex)) {
                return null;
            }
            return common.JsonPointer.toKey(this.getDataPointer(ctx));
        };
        JsonSchemaFormService.prototype.getLayoutArray = function (ctx) {
            return common.JsonPointer.get(this.layout, this.getLayoutPointer(ctx), 0, -1);
        };
        JsonSchemaFormService.prototype.getParentNode = function (ctx) {
            return common.JsonPointer.get(this.layout, this.getLayoutPointer(ctx), 0, -2);
        };
        JsonSchemaFormService.prototype.getDataPointer = function (ctx) {
            if (!ctx.layoutNode || !common.isDefined(ctx.layoutNode.dataPointer) || !common.hasValue(ctx.dataIndex)) {
                return null;
            }
            return common.JsonPointer.toIndexedPointer(ctx.layoutNode.dataPointer, ctx.dataIndex, this.arrayMap);
        };
        JsonSchemaFormService.prototype.getLayoutPointer = function (ctx) {
            if (!common.hasValue(ctx.layoutIndex)) {
                return null;
            }
        ...
        JsonSchemaFormService.prototype.isControlBound = function (ctx) {
            ...
            return controlGroup ? common.hasOwn(controlGroup.controls, name) : false;
        };
        JsonSchemaFormService.prototype.addItem = function (ctx, name) {
            if (!ctx.layoutNode || !common.isDefined(ctx.layoutNode.$ref) ||
                !common.hasValue(ctx.dataIndex) || !common.hasValue(ctx.layoutIndex)) {
                return false;
            }
            var newFormGroup = common.buildFormGroup(this.templateRefLibrary[ctx.layoutNode.$ref]);
            ...
            var newLayoutNode = common.getLayoutNode(ctx.layoutNode, this);
            ...
            if (name) {
                ...
                newLayoutNode.dataPointer += '/' + common.JsonPointer.escape(name);
                newLayoutNode.options.title = common.fixTitle(name);
            }
            common.JsonPointer.insert(this.layout, this.getLayoutPointer(ctx), newLayoutNode);
            return true;
        };
        JsonSchemaFormService.prototype.moveArrayItem = function (ctx, oldIndex, newIndex) {
            if (!ctx.layoutNode || !common.isDefined(ctx.layoutNode.dataPointer) ||
                !common.hasValue(ctx.dataIndex) || !common.hasValue(ctx.layoutIndex) ||
                !common.isDefined(oldIndex) || !common.isDefined(newIndex) || oldIndex === newIndex) {
                return false;
            }
        ...
        JsonSchemaFormService.prototype.removeItem = function (ctx) {
            ...
            common.JsonPointer.remove(this.layout, this.getLayoutPointer(ctx));
            return true;
        };
    ...
    function buildTitleMap(titleMap, enumList, fieldRequired, flatList) {
            ...
            if (common.isArray(titleMap)) {
                if (enumList) {
                    try {
                        for (var _e = __values$1(Object.keys(titleMap)), _f = _e.next(); !_f.done; _f = _e.next()) {
                            ...
                            else if (common.isString(titleMap[i])) {
                ...
                try {
                    for (var _g = __values$1(Object.keys(enumList)), _h = _g.next(); !_h.done; _h = _g.next()) {
                        var i = _h.value;
                        var value = enumList[i];
                        if (common.hasOwn(titleMap, value)) {
        ...
        if (newTitleMap.some((function (title) { return common.hasOwn(title, 'group'); }))) {
            hasEmptyValue = false;
            if (flatList) {
                newTitleMap = newTitleMap.reduce((function (groupTitleMap, title) {
                    if (common.hasOwn(title, 'group')) {
                        if (common.isArray(title.items)) {
                        ...
                        if (common.hasOwn(title, 'name') && common.hasOwn(title, 'value')) {
    ...
    var SelectFrameworkComponent = (function () {
        ...
        SelectFrameworkComponent.propDecorators = {
            ...
            layoutIndex: [{ type: core.Input }],
            dataIndex: [{ type: core.Input }],
            widgetContainer: [{ type: core.ViewChild, args: ['widgetContainer', { read: core.ViewContainerRef, static: true },] }]
        };
    ...
    var WidgetLibraryService = (function () {
        ...
        WidgetLibraryService.prototype.hasWidget = function (type, widgetSet) {
            ...
            return common.hasOwn(this[widgetSet], type);
        };
        ...
        WidgetLibraryService.prototype.unRegisterWidget = function (type) {
            if (!common.hasOwn(this.registeredWidgets, type)) {
                return false;
            }
    ...
    var FrameworkLibraryService = (function () {
        ...
        FrameworkLibraryService.ctorParameters = function () { return [
            { type: Array, decorators: [{ type: core.Inject, args: [common.Framework,] }] },
    ...
    var WidgetLibraryModule = (function () {
        ...
        WidgetLibraryModule.decorators = [
            { type: core.NgModule, args: [{
                        imports: [common$1.CommonModule, forms.FormsModule, forms.ReactiveFormsModule],
                        declarations: [
...
//# sourceMappingURL=ngsf-widget-library.umd.js.map
