...
class InputComponent {
    ...
    static ɵfac = function InputComponent_Factory(t) { return new (t || InputComponent)(i0.ɵɵdirectiveInject(i1.JsonSchemaFormService)); };
